...
namespace C_Sharp_var_10{
  public static class DatabaseController {
    ...
    public static void ReadDatabase(List<Product> products, List<Shop> shops, List<ProductMovement> productMovements) {
    ...
    public static void PrintProducts(List<Product> products) {
      ...
      var table = new ConsoleTable("Артикул", "Отдел", "Наименование товара", "Единица измерения", "Количество в упаковке", "Цена за упаковку");
      foreach (var product in products) {
        table.AddRow(product.Article, product.Department, product.Name, product.Unit, product.ItemsPerPackage, product.Price);
      }
    ...
    public static void DeleteProduct(List<Product> products,List<ProductMovement> productMovements, uint key){
    ...
    public static void DeleteShop(List<Shop> shops, List<ProductMovement> productMovements,string key){
    ...
    public static void UpdateProductMovement(List<Product> products, List<Shop> shops,List<ProductMovement> productMovements, uint key){
      ProductMovement? productMovement = productMovements.Find(x => x.OperationId == key);
      if (productMovement == null) {
        Console.WriteLine("Данное движение товаров не найдено.");
    ...
    public static void AddProductMovement(List<Product> products, List<Shop> shops, List<ProductMovement> productMovements){
      ...
      ProductMovement productMovement = new ProductMovement(operationId, date, shopId,productArticle, packageCount, operationType);
