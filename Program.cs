   ...
   Console.WriteLine("3. Добавление движения товара.");
     ...
     Console.WriteLine("3. Найти список адресов магазинов, в которых продавался определённый товар");
          Console.WriteLine("4. Найти общую сумму продаж в определённом районе");
           Console.WriteLine("==========================================================================");
   Console.WriteLine();
 Console.Write("Введите номер действия: ");switch (Console.ReadLine()) {
                         case "1": {
                         ...
                         case "2": {
                                    ...
                                    List<string> operations = DatabaseController.GetDepartmentOperations( products, productMovements, department);
                            ...
                            case "3": {
                                    ...
                                    try {
                                        productName = Console.ReadLine();if (string.IsNullOrEmpty(productName)) throw new Exception();
                                    ...
                                    List<string> addresses = DatabaseController.FindShopAddressesWhereProductWasSold(products, shops, productMovements, productName);
                            ...
                            case "4": {
                                    ...
                                    // Расчёт суммы
                                    int sum = DatabaseController.GetTotalDistrictRevenue(products, shops, productMovements, district);
